...
export function SummaryCards({ currentMonth, lastMonth }: SummaryCardsProps) {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
      <Card className="group relative overflow-hidden rounded-2xl shadow-sm transition-all duration-200 hover:shadow-md hover:-translate-y-0.5 border-rose-100/50 bg-gradient-to-br from-white to-rose-50/30">
      ...
      <Card className="group relative overflow-hidden rounded-2xl shadow-sm transition-all duration-200 hover:shadow-md hover:-translate-y-0.5 border-stone-100/50 bg-gradient-to-br from-white to-stone-50/30">
        <CardContent className="p-5">
          <div className="flex items-start justify-between mb-3">
