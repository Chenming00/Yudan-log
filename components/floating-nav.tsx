...
export function FloatingNav() {
  ...
  return (
    <nav
      aria-label="全局底部导航"
      className="fixed inset-x-0 bottom-0 z-40 border-t border-border/50 bg-white/80 backdrop-blur-xl px-3 pb-[calc(env(safe-area-inset-bottom)+10px)] pt-2 lg:px-6"
    >
